...
public class SimpleMeshGenerator_Noah : MonoBehaviour
{
	...
	protected void BuildMesh(string gameObjectName, Vector3[] vertices, int[] indices, Vector2[] uvs = null, Vector3[] normals = null)
	{
